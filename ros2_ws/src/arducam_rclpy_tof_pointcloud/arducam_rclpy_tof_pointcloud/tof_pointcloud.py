...
# apt install ros-humble-sensor-msgs-py python3-opencv python3-numpy && pip3 install ArducamDepthCamera 
    ...
    def __generateSensorPointCloud(self):
        while self.running_:
            ...
            if frame is not None and isinstance(frame, DepthData):
                ...
                self.depth_msg_.data = (depth_buf.flatten() / 1000).astype(np.float32).tolist()
