...
ArduinoICM20948Settings icmSettings =
{
  ...
  .gyroscope_frequency = 150,           // Max frequency = 225, min frequency = 1
  .accelerometer_frequency = 150,       // Max frequency = 225, min frequency = 1
  ...
  .quaternion9_frequency = 1,        // Max frequency = 225, min frequency = 50
  .har_frequency = 1,                // Max frequency = 225, min frequency = 50
  .steps_frequency = 1               // Max frequency = 225, min frequency = 50
...
void loop() 
{
  ...
  {
    icm20948.task();
    run_icm20948_quat6_controller(false);
